...
######################################################################################################################
SECTOR_TWO_MIN_IDS = {}
# We will add three mission ids to the pipeline: Only TESS objects can be introduced here.
# Note that we can select 'all' the sectors or quarters or specify a subset of them. In this case, the first object will
# be processed only using its 13th sector and each of the Kepler and K2 last object sectors will be analyzed independently.
SECTOR_FFI_IDS = {'TIC 299798795': [13], 'TIC 231663901': 'all'}

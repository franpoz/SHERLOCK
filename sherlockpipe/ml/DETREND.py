...
class AutoEncoder():
    ...
    def build(self):
        ...
        self.enc_layer7 = keras.layers.normalization.batch_normalization.BatchNormalization()(self.enc_layer7_r)
        ...
        self.dec_layer7 = keras.layers.normalization.batch_normalization.BatchNormalization()(self.dec_layer7)

...
def extract_custom_class(module_path: str):
    """
...
def get_from_dict(target: dict, key: str):
    """
...
def get_from_dict_or_default(target: dict, key: str, default):
    """
    ...
    :return: the final value for the key
    """
    value = get_from_dict(target, key)
    return value if value is not None else default


def get_from_user_or_config(target: dict, user_properties: dict, key: str):
    """
...
def get_from_user_or_config_or_default(target: dict, user_properties: dict, key: str, default):
    """

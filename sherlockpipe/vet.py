...
if __name__ == '__main__':
    ...
    ap.add_argument('--gpt', action='store_true', default=False, help="The number of CPU cores to be used.", required=False)
    ap.add_argument('--gpt_key', type=str, default=None, help="The number of CPU cores to be used.", required=False)
    args = ap.parse_args()
